...
from demoqa_tests.model.methods.radiobutton import Radio
...
class PracticePage:
    ...
    def send_image(self, student):
        browser.element('#uploadPicture').set_value(path.generate_path_upload(student.image))
        return self
